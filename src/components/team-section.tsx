            ...
            <div className="grid lg:grid-cols-2">
              ...
              <div className="p-8 md:p-12 flex flex-col lg:flex-row items-start gap-6 border-r border-gray-200">
                <div className="flex-shrink-0">
                  <img src="/james-stirrat-ellis-headshot.png" alt="James Stirrat-Ellis" className="w-48 h-48 object-cover" />
                </div>
              ...
              <div className="p-8 md:p-12 flex flex-col lg:flex-row items-start gap-6">
                <div className="flex-shrink-0">
                  <img src="/ben-mcclusky-cto-headshot.png" alt="Ben McClusky" className="w-48 h-48 object-cover" />
                </div>
                <div className="flex-1">
